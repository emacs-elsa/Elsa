...
(put 'bool-vector-p 'elsa-type (elsa-make-type (function (mixed) bool)))
(put 'arrayp 'elsa-type (elsa-make-type (function (mixed) bool)))
(put 'sequencep 'elsa-type (elsa-make-type (function (mixed) bool)))
(put 'bufferp 'elsa-type (elsa-make-type (function (mixed) bool)))
(put 'markerp 'elsa-type (elsa-make-type (function (mixed) bool)))
...
(put 'number-or-marker-p 'elsa-type (elsa-make-type (function (mixed) bool)))
(put 'floatp 'elsa-type (elsa-make-type (function (mixed) bool)))
;; TODO: generic
...
(put 'max 'elsa-type (elsa-make-type (function ((or number marker) &rest (or number marker)) bool)))
(put 'min 'elsa-type (elsa-make-type (function ((or number marker) &rest (or number marker)) bool)))
...
(put 're-search-backward 'elsa-type (elsa-make-type (function (string (or int nil) mixed) (or int nil))))
(put 're-search-forward 'elsa-type (elsa-make-type (function (string (or int nil) mixed) (or int nil))))
...
(put 'overlayp 'elsa-type (elsa-make-type (function (mixed) bool)))
